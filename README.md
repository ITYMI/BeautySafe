...
| **Случайные нарушители** (как отдельно выделенный подклас внешних нарушителей) | Случайные люди, любители (скрипт-кидди), тестировщики | Демонстрация навыков, случайное нарушение работы системы        | - Случайное нарушение работы системы<br>- Перехват данных при передаче<br>- Использование известных уязвимостей | - Обучение пользователей<br>- Регулярные обновления <br>- Шифрование данных  |
